...
/*
 * Color Adjustment Code from FrankerFaceZ
 * Code Licensed under Apache 2
 * See https://www.github.com/frankerfacez/FrankerFaceZ for more.
*/
...
Color.Adjuster = class ColorAdjuster {
	constructor(base = '#232323', mode = 1, contrast = 4.5) {
